...
![image](assets/Screenshot_Main_Form.png)

### Features:

1.) **Adding Clients**: The script allows users to easily add or delete clients from the tracking system.

![image](assets/Screenshot_Entry_Form.png)

2.) **Deleting Clients**: Users can remove clients from the tracking system when they are no longer relevant.
...
4.) **Preview with Update**: The main form provides a preview of the current transfer thresholds with updated timeframes.
